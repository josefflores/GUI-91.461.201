            ...
            <div class="header">
                ...
                <div class="title-wrapper">
                    ...
                    <nav class="horizontal">
                        <ul>
                            <li><a href="' , $A[ 'W_ROOT' ] , '"> Home </a></li>
                            <li><a href="' , $A[ 'W_ROOT' ] , 'about/"> About </a></li>
                            <li><a href="' , $A[ 'W_ROOT' ] , 'assignment/"> Assignments </a></li>
                            <li><a href="' , $A[ 'W_ROOT' ] , 'phpSource/"> PHP Source </a></li>
                        </ul>
                    </nav>
