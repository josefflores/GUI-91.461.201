            ...
            <div class="content">
                ...
                <img class="description" src="<?php echo $A[ 'W_IMG' ] ; ?>assignment.png" alt="assignment logo" >
                    ...
                    <div class="description" >
                        ...
                        <br/>
                        <h5> Before </h5>
                        <p> This section will show how the previous tags found under Elements look by default.</p>

                        <div class="sample"><h1 class="example-1">Content Title h1 tag</h1></div>
                        ...
                        <div class="sample"><p class="example-1"> I am writing this paragraph to show how we use span tags to change subsections. I will use the span tag to highlight the words <span class="highlight"> highlight </span> and <span> hide </span>. I will also use the span tag to change how a <span>title</span> is presented. </p> </div>
