        ...
        <div class="wrapper">
                    ...
                    <nav class="horizontal">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="<?php echo $A[ 'W_ROOT' ] ; echo 'assignments/4/' ; ?>">
                                    Instructions
                                </a>
                            ...
                            <li>
                                <a href="<?php echo $A[ 'W_ROOT' ] ; echo 'assignments/4/work/' ; ?>">
                                    Work
                                </a>
                            </li>
            ...
            <div class="content">
                ...
                <div class="description" >
                    ...
                    <p>
                        <a href="https://teaching.cs.uml.edu/~heines/91.461/91.461-2014-15f/461-assn/PostingToGitHub-v01.jsp">
                            Assignment 4 Instructions - Posting a Page to GitHub
                        </a>
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            Created web page for the project: <a href="http://josefflores.github.io/GUI-91.461.201/"> Github Page</a>
                        </li>
