<?php
     ...
     *
     *  This file holds the instructions for the assignment 9.
     *
    ...
    <head>
        ...
        <!--
            ...
            updated by JFF on November 20, 2014 at 12:30
                Updated web page for assignment 9
        ...
        <div class="wrapper">
            ...
            <div class="content">
                ...
                <div class="description" >
                    ...
                    <p>
                        <a href="//teaching.cs.uml.edu/~heines/91.461/91.461-2014-15f/461-assn/UsingAngularJS-v01.jsp">
                            Assignment 9 Instructions - Using AngularJS
                        </a>
                    </p>

                    <ul>

                        <li>Watched <a href="//www.youtube.com/watch?v=TRrL5j3MIvo&feature=youtu.be" target="_blank">Curran’s video</a> on AngularJS and looked at resources provided, as well as online documentation.</li>
                        <li>Ran the starter code and reviewed the source file.</li>
                        <li>Decided to use <a href="http://www.disneymovieslist.com/disney-movies.asp">List of Disney movies</a></li>
                        <li>Modified the starter code including the CSS and filter files to create application. Documented which sections of code came from the starter code.</li>
                        <li>Added at least one additional form of interaction to the page: { used  buttons, check boxes, radio buttons, drop down lists, etc. }</li>
                        <li>Tested application, and handled errors and use cases.</li>
