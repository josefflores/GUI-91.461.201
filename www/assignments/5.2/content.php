        ...
        <div class="wrapper">
                    ...
                    <nav class="horizontal">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="<?php echo $A[ 'W_ROOT' ] ; echo 'assignments/5.2/' ; ?>">
                                    Instructions
                                </a>
                            ...
                            <li>
                                <a href="<?php echo $A[ 'W_ROOT' ] ; echo 'assignments/5.2/work/?col=1' ; ?>">
                                    Work 1 Column
                                </a>
                            </li>

                            <li>
                                <a href="<?php echo $A[ 'W_ROOT' ] ; echo 'assignments/5.2/work/?col=2' ; ?>">
                                    Work 2 Columns
                                </a>
                            </li>

                            <li>
                                <a href="<?php echo $A[ 'W_ROOT' ] ; echo 'assignments/5.2/work/?col=3' ; ?>">
                                    Work 3 Columns
                                </a>
                            </li>
            ...
            <div class="content">
                ...
                <div class="description" >
                    ...
                    <p>
                        This is a modification of Assignment 5, that was done as an in class assignment. It is intended to extend the assignment by adding multi column layouts.
