                        ...
                        <ul class="list">
                            <li>
                                <div>
                                    ...
                                    <div> Url is in the project and it did not pass validation. This image is also a link to the test results.</div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div>
                                    ...
                                    <div> Url is in the project and it passed validation. This image is also a link to the test results.</div>
                                </div>
                            </li>
                   ...
                   if( is_file( $json_src ) ) {
                        ...
                        foreach( $json as $item ) {
                            if ( $item[ 'STATE' ] == 'SKIP' ) {
                                echo '<li>
                                <div>
                                    <div><img alt="Was not tested" src="' , $A[ 'W_IMG' ] , $icon , '.png"></div>
                                    <div><a href="' , $item[ 'LINK' ] , '">' , $item[ 'LINK' ] , '</a></div>
                                </div>
                            </li>
                            ' ;
